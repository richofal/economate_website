...
const FinancialServices = () => {
  return (
    <div className="bg-[#F2F9FF] flex items-center justify-center">
      <div className="w-full max-w-screen-xl px-4 sm:px-6 lg:px-8 md:py-25 lg:py-0">
        <div className="text-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl px-14 text-center font-extrabold font-semibold text-gray-800 mb-15">
            Cari Layanan Yang Kamu Inginkan
          </h1>
          <div className="grid grid-cols-1 px-10 md:grid-cols-3 gap-6">
          ...
          <div className="grid px-10 grid-cols-1 md:grid-cols-2 gap-6 mt-6 justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg border border-[#C5BAFFB2]">
              <div className="flex justify-center mb-4">
                <Image
                  src="/split.png"
